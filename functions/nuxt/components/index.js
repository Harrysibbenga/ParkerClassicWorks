...
export { default as SectionDetailContact } from '../../components/Section/detailContact.vue'
...
export { default as ServiceApiCheck } from '../../components/Service/apiCheck.vue'
...
export const LazySectionDetailContact = import('../../components/Section/detailContact.vue' /* webpackChunkName: "components/section-detail-contact" */).then(c => wrapFunctional(c.default || c))
...
export const LazyServiceApiCheck = import('../../components/Service/apiCheck.vue' /* webpackChunkName: "components/service-api-check" */).then(c => wrapFunctional(c.default || c))
