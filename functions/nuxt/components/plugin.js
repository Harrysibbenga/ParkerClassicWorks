...
const components = {
  ...
  DetailVideo: () => import('../../components/Detail/video.vue' /* webpackChunkName: "components/detail-video" */).then(c => wrapFunctional(c.default || c)),
  ...
  ModalsManual: () => import('../../components/Modals/manual.vue' /* webpackChunkName: "components/modals-manual" */).then(c => wrapFunctional(c.default || c)),
  ...
  SectionDetailContact: () => import('../../components/Section/detailContact.vue' /* webpackChunkName: "components/section-detail-contact" */).then(c => wrapFunctional(c.default || c)),
  ...
  ServiceApiCheck: () => import('../../components/Service/apiCheck.vue' /* webpackChunkName: "components/service-api-check" */).then(c => wrapFunctional(c.default || c)),
